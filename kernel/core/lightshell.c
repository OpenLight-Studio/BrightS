...
static void print_tui_banner(void)
{
  ...
  brights_serial_write_ascii(BRIGHTS_COM1_PORT, "  \033[1;32m[✓]\033[0m \033[1;37mVFS Layer\033[0m\r\n");
  brights_serial_write_ascii(BRIGHTS_COM1_PORT, "  \033[1;32m[✓]\033[0m \033[1;37mNetwork Stack\033[0m\r\n");
  brights_serial_write_ascii(BRIGHTS_COM1_PORT, "\r\n");
  brights_serial_write_ascii(BRIGHTS_COM1_PORT, "  \033[1;33mType 'help' for available commands\033[0m\r\n");
  brights_serial_write_ascii(BRIGHTS_COM1_PORT, "\r\n");
}
...
static void cmd_help(void)
{
  ...
  brights_serial_write_ascii(BRIGHTS_COM1_PORT,
    "  \033[1;36mFile Ops\033[0m:  ls cat touch write append cp mv rm hexdump stat\r\n");
  brights_serial_write_ascii(BRIGHTS_COM1_PORT,
    "  \033[1;36mDir Ops\033[0m:   pwd cd mkdir rmdir mount\r\n");
  brights_serial_write_ascii(BRIGHTS_COM1_PORT,
  ...
  brights_serial_write_ascii(BRIGHTS_COM1_PORT,
    "  \033[1;36mUser\033[0m:      whoami login logout passwd useradd profile\r\n");
  brights_serial_write_ascii(BRIGHTS_COM1_PORT,
    "  \033[1;36mMisc\033[0m:      help echo history\r\n");
  brights_serial_write_ascii(BRIGHTS_COM1_PORT,
    "\033[1;33m─── bst subcommands ───────────────────────────────────────\033[0m\r\n");
  brights_serial_write_ascii(BRIGHTS_COM1_PORT,
    "  bst help procom\r\n");
}
...
static void cmd_mount(void)
{
  if (brights_boot_fs_mount_external("manual") == 0) {
